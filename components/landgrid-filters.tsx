  ...
  return (
    <div className="lg-shell-overlay">
      ...
      <style>{`
        ...
        @media(max-width:767px){.lg-filter-trigger{left:10px;top:10px;height:40px}.lg-modal-backdrop{align-items:flex-end;justify-content:center;padding:0;background:rgba(15,23,42,.24)}.lg-filter-modal{width:100%;height:min(82dvh,680px);max-height:calc(100dvh - env(safe-area-inset-top) - 8px);border-radius:18px 18px 0 0;border-left:0;border-right:0;border-bottom:0}.lg-modal-header{padding:13px 15px}.lg-tabs button{height:44px}.lg-modal-content{padding:13px 14px}.lg-modal-footer{padding-bottom:max(11px,env(safe-area-inset-bottom))}}
      `}</style>
    </div>
  );
}
